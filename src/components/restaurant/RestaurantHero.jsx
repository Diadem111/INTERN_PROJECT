    ...
    <section className=" bg-restaurant bg-cover bg-no-repeat h-[45rem] max-sm:h-[35rem] max-mds:h-[40rem] mlg:h-[50rem] xl:h-[60rem]">
      <div className="z-10">
        <div className="text-white z-50 flex flex-col items-center gap-8 pt-[14%] w-full h-full ">
          <h1 className="max-xs:text-4xl xs:text-4xl xl:text-7xl sm:text-6xl font-zodiak font-bold text-center">
            {card.name}
          </h1>
          <p className=" w-1/2 text-center max-xs:text-sm xs:text-base xl:text-2xl font-lato">
            {card.text}
          </p>
          <button
