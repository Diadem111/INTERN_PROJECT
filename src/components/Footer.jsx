    ...
    `}>
      ...
      flex-col mb-8 w-full`}>
       <div className='flex-1 flex flex-col justify-start ml-10 mt-8'>
        ...
        <p className={`${styles.para} mt-2 max-w-[310px] font-poppins text-sm`}>
          Follow us on our social <br/>platforms</p>
